...
import static org.infinispan.persistence.redis.configuration.ExecutorFactoryConfiguration.EXECUTOR_FACTORY;

/**
 * Configures executor factory.
 */
public class ExecutorFactoryConfigurationBuilder extends AbstractRedisStoreConfigurationChildBuilder<RedisStoreConfigurationBuilder> implements Builder<ExecutorFactoryConfiguration> {
   private final AttributeSet attributes;
   ExecutorFactoryConfigurationBuilder(RedisStoreConfigurationBuilder builder) {
      super(builder);
